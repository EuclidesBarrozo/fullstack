            ...
            <div class="container">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0">LISTA DE CLIENTES</h2>
                        <hr class="divider" />
                ...
                <div class="row mb-5 text-center d-none d-lg-block">
                    <div class="col-lg-12 col-sm-12">
                        <div class="m-2">
                            <a href='clientes.php' class='btn btn-warning'>Cadastrar Cliente</a>
                            <button class='btn btn-warning' onclick="abrirModalFiltros()">Filtrar Clientes</button>
...
$sql = "SELECT clientes.ID, clientes.Nome, clientes.Contratou, clientes.Telefone1, clientes_solicitacao.Disponibilidade, clientes_solicitacao.Baba, clientes_solicitacao.Cozinheira, clientes_solicitacao.Cuidadora, clientes_solicitacao.Domestica, clientes_solicitacao.Faxineira, clientes_solicitacao.F_Baba, clientes_solicitacao.F_Cuidadora FROM clientes, clientes_solicitacao WHERE clientes.ID_Solicitacao = clientes_solicitacao.ID LIMIT 0, 10";
...
if($result) {
    ...
    while($linha = mysqli_fetch_array($result)){
        ...
        <form action='update_cliente.html.php' method='POST'>
        <td data-label='Nome'>".$linha["Nome"]."</td>
        <td data-label='Telefone'>".$linha["Telefone1"]."</td>
        <td data-label='Contratou'>".$linha["Contratou"]."</td>
        ...
        <td class='centralizarMobile'><input class='btn
    ...
    <thead>
        <tr>
            <td class='justify-content-center' colspan='11'>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-floating mb-3">
            ...
            <label for="selDisponibilidade">Disponibilidade de Serviço</label>
        </div>
      </div>
      <div class="modal-footer">
        ...
        <script>
            ...
            function aplicarFiltros(){
                ...
                if (nome != ""){json.nome = nome;}
                if (cpf != ""){json.cpf = cpf;}
                if (cidade != ""){json.cidade = cidade;}
                if (servico != ""){json.servico = servico;}
                if (disponibilidade != ""){json.disponibilidade = disponibilidade;}
                
                if (nome != "" || cpf != "" || cidade != "" || servico != "" || disponibilidade != "")
                {
                    $.ajax({
                        url: "./querys.php",
                        method: "POST",
                        data: {filtroTabela : "sim", tabela : "clientes", filtroData : JSON.stringify(json)},
                        success: (data) => {
            ...
            function removerFiltros(){
                ...
                $.ajax({
                    url: "./querys.php",
                    method: "POST",
                    data: {tabelaNormal: "sim", tabela : "clientes", removerFiltro: "sim"},
                    success: (data) => {
                        tabela.innerHTML = data;
            ...
            function atualizarPagina(elemento){
                ...
                if (!elemento.classList.contains('btn')){
                    ...
                    $.ajax({
                        url: "querys.php",
                        method: "POST",
                        data: {atualizarPag: pag, tabela: "clientes"},
                        success: (data) => {
