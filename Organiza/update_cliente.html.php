...
<html lang="pt-br">
    ...
    if(isset($_SESSION["msg_update"])){
        if($_SESSION["msg_update"] == "1" ||  $_SESSION["msg_update"] == null)
        echo "<script> alert('Cadastro atualizado com sucesso'); </script>";
        if($_SESSION["msg_update"] == "2" )
   ...
   */
    ...
    /*
    $sql = "SELECT cliente.ID, cliente.Nome, cliente.Telefone1, solicitacao.Disponibilidade, solicitacao.Baba, solicitacao.Cozinheira, solicitacao.Cuidadora, solicitacao.Domestica, solicitacao.Faxineira, solicitacao.F_Baba, solicitacao.F_Cuidadora FROM cliente, solicitacao WHERE cliente.ID = 12 and cliente.ID_Solicitacao = solicitacao.ID";
    */
    $sql = "SELECT * FROM clientes, clientes_endereco, clientes_solicitacao WHERE clientes.ID = '$id' and clientes.ID_Endereco = clientes_endereco.ID and clientes.ID_Solicitacao = clientes_solicitacao.ID";
    ...
    $rg = $linha['RG']?$linha['RG'] : "";
    $telefone1 = $linha['Telefone1']?$linha['Telefone1'] : "";
    $telefone2 = $linha['Telefone2']?$linha['Telefone2'] : "";
    $data_nascimento = $linha['Data_Nascimento']?$linha['Data_Nascimento'] : "";
    $profissao = $linha['Profissao']?$linha['Profissao'] : "";
    $observacao = $linha['Observacao']?$linha['Observacao'] : "";

    $rua = $linha['Rua']?$linha['Rua'] : "";
    $numero = $linha['Numero']?$linha['Numero'] : "";
    ...
    $Baba = $linha['Baba']?"Checked" : "";
    $Domestica = $linha['Domestica']?"Checked" : "";
    $Cozinheira = $linha['Cozinheira']?"Checked" : "";
    $Cuidadora = $linha['Cuidadora']?"Checked" : "";
    $Faxineira = $linha['Faxineira']?"Checked" : "";
    $F_Baba = $linha['F_Baba']?"Checked" : "";
    $F_Cuidadora = $linha['F_Cuidadora']?"Checked" : "";
echo "
 
                        <form name='form1' action='update_cliente.php' method='post'>
                            <fieldset><legend>Dados Pessoais</legend>
                            <!-- Name input-->
                            <div class='form-floating mb-3'>
                             
                            <input class='form-control' name='nome' id='name' type='text' value='".$nome."' onblur='V_nome(this)' required />
                            ...
                            <!-- Email address input-->
                            <div class='form-floating mb-3'>
                                <input class='form-control' id='mail' type='text' value='".$rg."' name='rg' onblur='V_rg(this)' oninput='formatRg(this)'/>
                                <label for='email'>RG*</label>
                                <p id='l_rg'></p>
                            </div>

                            <div class='form-floating mb-3' >
                                <input class='form-control' id='mail' type='text' value='".$cpf."' name='cpf' onblur='V_cpf(this)'/>
                            ...
                            <!-- Phone number input-->
                            <div class='form-floating mb-3'>
                                <input class='form-control' id='phone' type='tel'  value='".$telefone1."' name='telefone1' onblur='V_tel1(this)' onkeyup='formatNumero(this)' required/>
                                <label for='phone'>Telefone*<span style='font-size:x-small;'>(Whatsapp)</span></label>
                                <p id='l_tel1'></p>
                            </div>
                            <div class='form-floating mb-3'>
                                <input class='form-control' id='phone' type='tel' value='".$telefone2."' name='telefone2' onblur='V_tel2(this)'  onkeyup='formatNumero(this)'/>
                            ...
                            <div class='form-floating mb-3'>
                                <input class='form-control' id='mail' type='date' value='".$data_nascimento."' name='data_nascimento'/>
                                <label for='email'>Data de Nascimento*</label>
                            </div>

                            <div class='form-floating mb-3'>
                                <input class='form-control' id='name' type='text' value='".$profissao."'  name='profissao'/>
                            ...
                            <fieldset><legend>Endereço</legend>
                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='text' value='".$rua."'  name='rua' onblur='V_rua(this)' required/>
                                    <label for='name'>Rua*</label>
                                </div>

                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='number'value='".$numero."' min='0' name='numero' onblur='V_num(campo)' required/>
                                    <label for='name'>Número*</label>
                                </div>

                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='text' value='".$bairro."'  name='bairro' onblur='V_bairro(this)' required/>
                                    <label for='name'>Bairro*</label>
                                </div>

                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='text' value='".$cidade."'  name='cidade' onblur='V_cidade(this)' required/>
                                    <label for='name'>Cidade*</label>
                                </div>

                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='text' value='".$estado."' value='Ceará' name='estado' onblur='V_estado(this)' required/>
                                    <label for='name'>Estado*</label>
                                </div>

                                <div class='form-floating mb-3'>
                                    <input class='form-control' id='name' type='text' value='".$cep."' name='cep' />
                            ...
                            <!-- RUA, NÚMERO, BAIRRO, CIDADE, ESTADO, CEP -->
                                ...
                                <div class='form-check form-check-inline'>
                                    <input class='form-check-input' name='D' type='checkbox' ".$Domestica." value=true/> 
                            ...
                            <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='B' type='checkbox' ".$Baba." />
                            ...
                            <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='FB' type='checkbox' ".$F_Baba." />
                                ...
                                <tr>
                                    <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='F' type='checkbox' ".$Faxineira." value=true/>
                                    <label class='form-check-label' for='name'>Faxineira</label>
                                </div>
                            </td>
                            <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='Coz' type='checkbox' ".$Cozinheira." value=true/>
                            ...
                            <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='Cui' type='checkbox' ".$Cuidadora." value=true/>
                            ...
                            <tr>
                                <td>
                                <div class=' form-check form-check-inline'>
                                    <input class='form-check-input' name='FC' type='checkbox' ".$F_Cuidadora." value=true/>
                            ...
                            <div class='d-grid'><input class='btn btn-success' type='submit' value='Editar'></div>";
